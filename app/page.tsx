...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5d4a1] flex flex-col text-[#3f2a1d]">
      <header className="sticky top-0 z-10 bg-[#f5d4a1] p-4 flex flex-wrap justify-between items-center gap-4">
      ...
      <section className="w-full bg-[#f5d4a1]" aria-label="Themed Road Trips">
        <img
          src="/hero.png"
